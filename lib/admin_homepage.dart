...
import 'package:hsms/Members/MembersList.dart';
import 'package:hsms/Notices/Notices.dart';
import 'package:hsms/Profile.dart';
...
class AdminHomePage extends StatefulWidget{
  ...
  AdminHomePage({Key key, this.auth, this.onSignOut, this.userId, this.userEmail, this.userType = "default"}):super(key:key);
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              ...
              FlatButton(onPressed: () {Navigator.push(context,
                  ...
                  child: Image.asset(("images/members.png"), width: 160, height: 130,)),
            ],
          ),
          Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: <Widget>[
